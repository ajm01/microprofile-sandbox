...
public class MPOpenAPIBoosterTest {
    ...
    public void testMPOpenAPIBoosterFeature10() throws Exception {
        ...
        LibertyMPOpenAPIBoosterConfig libMPOpenAPIConfig = new LibertyMPOpenAPIBoosterConfig(BoosterUtil.createDependenciesWithBoosterAndVersion(LibertyMPOpenAPIBoosterConfig.class, "0.1.0-SNAPSHOT"), logger);
