...
public class JAXRSBoosterTest {
     ...
     * version is set to 0.2.0-SNAPSHOT
     * 
     */
    @Test
    public void testJAXRSBoosterFeature20() throws Exception {
        ...
        LibertyJAXRSBoosterConfig libJAXRSConfig = new LibertyJAXRSBoosterConfig(BoosterUtil.createDependenciesWithBoosterAndVersion(LibertyJAXRSBoosterConfig.class, "0.2.0-SNAPSHOT"), logger);
     ...
     * version is set to 0.2.1-SNAPSHOT
     * 
     */
    @Test
    public void testJAXRSBoosterFeature21() throws Exception {
        ...
        LibertyJAXRSBoosterConfig libJAXRSConfig = new LibertyJAXRSBoosterConfig(BoosterUtil.createDependenciesWithBoosterAndVersion(LibertyJAXRSBoosterConfig.class, "0.2.1-SNAPSHOT"), logger);
