...
public class MPMetricsBoosterTest {
    ...
    public void testMPMetricsBoosterFeature11() throws Exception {
        ...
        LibertyMPMetricsBoosterConfig libMPMetricsConfig = new LibertyMPMetricsBoosterConfig(BoosterUtil.createDependenciesWithBoosterAndVersion(LibertyMPMetricsBoosterConfig.class, "0.1.1-SNAPSHOT"), logger);
